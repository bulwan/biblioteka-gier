import "../pages/gameDetails/gameDetails.scss";
  ...
  return (
    <div key={id} className="gameDetails__container">
      ...
      <div className="gameDetails__addToLibrary">
        <button>
          Add to library
          <img src="src\images\addToLibrary-icon.png" alt="abandoned-icon" />
        </button>
      </div>
      ...
      <div className="gameDetails__screenshotsContainer">
        ...
        ></img>
        <img src="src\images\game2-screenshots2.jpg" alt="game__screenshot2" />
      </div>
      ...
      <div className="gameDetails_description">
        <h1>
          The story follows bestselling thriller novelist Alan Wake, who has
          been trapped in an alternate dimension for 13 years, as he attempts to
          escape by writing a horror story involving an FBI agent named Saga
          Anderson.
        </h1>
      </div>
    </div>
