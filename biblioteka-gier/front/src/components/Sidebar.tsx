...
const Sidebar = ({
  ...
  const handleClick = (
    ...
    const sidebarData = [
      ...
      { className: "sidebar__bestOfAllTime", query: "page_size=25&metacritic=85,100", label: "Best of All Time" },
      { className: "sidebar__popular2023", query: "page_size=25&dates=2023-01-01,2023-12-31", label: "Popular in 2023" },
      { className: "sidebar__last30Days", query: `page_size=25&dates=${formattedPriorDate},${formatDate()}`, label: "Last 30 days" },
      { className: "sidebar__comingSoon", query: `page_size=25&dates=${formatDate()},${formattedSoonDate}`, label: "Coming soon" },
      { className: "sidebar__windows", query: `page_size=25&platforms=4`, label: "Games for PC" },
      { className: "sidebar__playstation5", query: `page_size=25&platforms=187`, label: "Games for Playstation 5" },
      { className: "sidebar__xboxSeries", query: `page_size=25&platforms=186`, label: "Games for Xbox Series S/X" },
      { className: "sidebar__xboxOne", query: `page_size=25&platforms=1`, label: "Games for Xbox One" },
      { className: "sidebar__xbox360", query: `page_size=25&platforms=14`, label: "Games for Xbox 360" },
      { className: "sidebar__xbox", query: `page_size=25&platforms=80`, label: "Games for Xbox" },
      { className: "sidebar__playstation4", query: `page_size=25&platforms=18`, label: "Games for Playstation 4" },
      { className: "sidebar__playstation3", query: `page_size=25&platforms=16`, label: "Games for Playstation 3" },
      { className: "sidebar__playstation2", query: `page_size=25&platforms=15`, label: "Games for Playstation 2" },
      { className: "sidebar__playstation", query: `page_size=25&platforms=27`, label: "Games for Playstation 1" },
      ...
      { className: "sidebar__adventure", query: `page_size=25&genres=3`, label: "Genre: Adventure" },
  ...
  return (
    <div className="sidebar">
      ...
      {createButton("Best of all time", "sidebar__bestOfAllTime", "bestOfAllTime", blockedButton === "bestOfAllTime")}
      {createButton("Popular in 2023", "sidebar__popular2023", "popular2023", blockedButton === "popular2023")}
      <p className="sidebar__titles">New Releases</p>
      {createButton("Last 30 days", "sidebar__last30Days", "last30Days", blockedButton === "last30Days")}
      {createButton("Coming soon", "sidebar__comingSoon", "comingSoon", blockedButton === "comingSoon")}
      <p className="sidebar__titles">Platforms</p>
      {createButton("PC", "sidebar__windows", "windows", blockedButton === "windows")}
      {createButton("Playstation 5", "sidebar__playstation5", "playstation5", blockedButton === "playstation5")}
      {createButton("Xbox Series S/X", "sidebar__xboxSeries", "xboxSeries", blockedButton === "xboxSeries")}
      {showPlatform && (
        <>
          {createButton("Xbox One", "sidebar__xboxOne", "xboxOne", blockedButton === "xboxOne")}
          {createButton("Playstation 4", "sidebar__playstation4", "playstation4", blockedButton === "playstation4")}
          {createButton("", "sidebar__xbox360", "xbox360", blockedButton === "xbox360")}
          {createButton("Playstation 3", "sidebar__playstation3", "playstation3", blockedButton === "playstation3")}
          {createButton("Xbox", "sidebar__xbox", "xbox", blockedButton === "xbox")}
          {createButton("Playstation 2", "sidebar__playstation2", "playstation2", blockedButton === "playstation2")}
          {createButton("Playstation 1", "sidebar__playstation", "playstation", blockedButton === "playstation")}
        </>
      )}
      <button
        className="sidebar__showAllPlatforms"
      ...
      <button
        className="sidebar__showAllGenres"
